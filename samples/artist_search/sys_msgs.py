...
query_msg = (
    'You are an AI assistant that responds to a user. You are an AI web search query generator model. '
...
best_search_msg = (
    'You are not an AI assistant.  You are an AI model trained to select the best '
    'search result out of a list of search results. The best search results is the link an expert human search '
    ...
    'the best search result to check the for the data the AI Assistant needs to respond.  That means your responses '
    'to this conversation must always be 1 token, being an integer between 0-9.'
)

contains_data_msg = (
    'You are not an AI Assistant that responds to a user. You are an AI assistant designed to analyze data scraped '
    'from web pages text to assist an actual AI assistant in responding correctly with up to date information. '
    'Consider the USER_PROMPT that was sent to the actual AI assistant and analyze the web page text to see if '
